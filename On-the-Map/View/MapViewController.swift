...
class MapViewController: UIViewController, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        var request = URLRequest(url: URL(string: OTMClient.OTMUrls.ParseLimit)!)
        request.addValue(OTMClient.HeaderValues.ParseAppID, forHTTPHeaderField: OTMClient.Headers.AppHeader)
        request.addValue(OTMClient.HeaderValues.ParseApiKey, forHTTPHeaderField: OTMClient.Headers.ApiHeader)
